...
hl.window_rule({ name = "scratchpad-stay-focused", match = { workspace = "special:magic" },  stay_focused = true })
hl.window_rule({ name = "foot-opacity",         match = { class = "foot" },                  opacity = "0.6 override 0.6 override 0.6 override" })
hl.window_rule({ name = "zed-opacity",          match = { class = "dev.zed.Zed" },           opacity = "0.75 override 0.75 override 0.75 override" })
hl.window_rule({ name = "nautilus-opacity",     match = { class = "org.gnome.Nautilus" },    opacity = "0.78 override 0.78 override 0.78 override" })
hl.window_rule({ name = "nautilus-width",       match = { class = "org.gnome.Nautilus" },    scrolling_width = 0.1675 })
